...
mkdir TGUserbot
cd TGUserbot
wget https://github.com/hamroyev/automoney/TGUserbot.phar
wget https://raw.githubusercontent.com/hamroyev/automoney/bot.php
chmod 777 TGUserbot.phar
apt-get -y install php7.2-cli
update-alternatives --set php /usr/bin/php7.2
echo OK
echo Automoney proekt from @khamroev
echo Telegram channel: @userbotuz
exit